...
"use strict";!function(c){Drupal.behaviors.gf_theme_gmap={attach:function(e,i){c(".no-touchevents .gmap",e).once("gmap-disable-zoom-scroll").click(function(){c(this).find("iframe").addClass("clicked")}).mouseleave(function(){c(this).find("iframe").removeClass("clicked")})}}}(jQuery);;
/**
 * @file
