...
"use strict";var TwitterFeed=function(e){function l(){for(var e=s.querySelectorAll(".bullet-list button.is-active"),t=0;t<e.length;t++){e[t].classList.remove("is-active")}s.querySelectorAll(".bullet-list button")[u].classList.add("is-active")}function a(){for(var e=0;e<o.length;++e){var t=o[e];t.classList.remove("is-active"),t.setAttribute("aria-hidden","true"),e===u&&(t.classList.add("is-active"),t.setAttribute("aria-hidden","false"))}l()}function t(){++u===o.length&&(u=0),a()}function c(){return window.setInterval(function(){t()},1e4)}function n(e){switch(e.key){case"Left":case"ArrowLeft":--u<0&&(u=o.length-1),a();break;case"Right":case"ArrowRight":t();break;case"Home":u=0,a();break;case"End":u=o.length-1,a();break;default:return}e.preventDefault()}function r(){var e=s.querySelector(".tweets-container");if(e){for(var t=e.querySelector(".bullet-list"),n=0;n<o.length;n++){var r=document.createElement("li"),i=document.createElement("button");i.setAttribute("data-id",n),i.innerText="Tweet "+(n+1),r.appendChild(i),t.appendChild(r)}l(),function(){for(var e=s.parentNode.querySelectorAll(".bullet-list button"),t=0;t<e.length;t++){e[t].addEventListener("click",function(e){e.preventDefault(),clearInterval(d),u=parseInt(this.getAttribute("data-id")),a(),d=c()})}a()}()}}var i,u=0,s=null,o=null,d=null;(i=e)&&(o=(s=i).querySelector(".tweets-list").children,d=c(),r(),s.addEventListener("keyup",function(e){e.defaultPrevented||n(e)}))};;
"use strict";Drupal.behaviors.gfThemeTweets={attach:function(e,t){for(var r=document.querySelectorAll(".twitter-widget"),i=0;i<r.length;++i)new TwitterFeed(r[i])}};;
